...
export const ownershipContractSchema = z.object({
    ...
    contractType: z.enum(["ASSET_RENTING", "SPACE_RENTING"]).default("ASSET_RENTING"),
...
export const clientSchema = z.object({
    ...
    panNumber: z.string().min(10, "Valid PAN is required (10 characters)"),
    address: z.string().min(1, "Address is required"),
    isActive: z.boolean().default(true),
    cityId: z.string().min(1, "City is required"),
...
export const vendorSchema = z.object({
    ...
    vendorType: z.enum(["LANDLORD", "AGENCY"]).default("LANDLORD"),
    contactPerson: z.string().min(1, "Contact person is required"),
